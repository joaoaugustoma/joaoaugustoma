<h2> Hi, I'm João Augusto! <img src="https://media.giphy.com/media/kdziwLPfMNkfpvuZx9/giphy.gif" width="50"></h2>
...
const languim = {
  ...
  architecture: ["microservices", "event-driven", "design system pattern", "RESTFul API", "JWT"],
};
```
